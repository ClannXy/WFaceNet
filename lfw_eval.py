...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='./model/best/wfacenet_066_9935.ckpt',
                        help='The path pf save model')
    parser.add_argument('--feature_save_dir', type=str, default='./result/features.mat',
    ...
    for i in range(len(ACCs)):
        print('{:3d}    {:.2f}'.format(i+1, ACCs[i] * 100))
    print('--------')
    print('AVE    {:.2f}'.format(np.mean(ACCs) * 100))
